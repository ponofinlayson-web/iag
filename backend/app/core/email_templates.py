...
_TEMPLATES: dict[str, dict[str, str]] = {
    ...
    "remediation_notify_owner": {
        "subject": "[IAG] Access revoked: {{ entitlement_name }} for {{ identity_name }}",
        "body": (
            "Hello {{ first_name }},\n"
            "\n"
            "A reviewer revoked access during certification campaign\n"
            "'{{ campaign_name }}'. You are the registered owner of the source\n"
            "'{{ data_source_name }}' and should take enforcement action.\n"
            "\n"
            "Account: {{ account_value }} ({{ account_type }})\n"
            "Privilege level: {{ privilege_level }}\n"
            "Entitlement: {{ entitlement_name }}\n"
            "Identity: {{ identity_name }}\n"
            "Reviewer comment: {{ reviewer_comment }}\n"
            "Action reference: action {{ action_id }} / review {{ review_id }}\n"
            "\n"
            "This notification was generated by IAG access governance."
        ),
    },
}
